 ...
 * Version: 1.0
 * Text Domain: metwit-weather-widget
 * License: GPL2

 Copyright 2011 Metwit LTD (email : duccio AT metwit DOT com)
...
define( 'MTW_VERSION', '1.0' );
define( 'MTW_PATH', dirname( __FILE__ ) );
define( 'MTW_PATH_INCLUDES', dirname( __FILE__ ) . '/inc' );
define( 'MTW_FOLDER', basename( MTW_PATH ) );
define( 'MTW_URL', plugins_url() . '/' . MTW_FOLDER );
define( 'MTW_URL_INCLUDES', MTW_URL . '/inc' );
...
class DX_Plugin_Base {
	 ...
	 */
	function dx_add_CSS() {
		wp_register_style( 'samplestyle', plugins_url( '/css/metwit-weather-widget.css', __FILE__ ), array(), '1.0', 'screen' );
	...
	function dx_add_admin_CSS() {
		wp_register_style( 'samplestyle-admin', plugins_url( '/css/metwit-weather-widget-admin.css', __FILE__ ), array(), '1.0', 'screen' );
	...
	function dx_plugin_base() {
		include_once( MTW_PATH_INCLUDES . '/base-page-template.php' );
	}
	...
	function dx_register_settings() {
		require_once( MTW_PATH . '/mtw-plugin-settings.class.php' );
	...
	function dx_sample_widget() {
		include_once MTW_PATH_INCLUDES . '/mtw-sample-widget.class.php';
	}
